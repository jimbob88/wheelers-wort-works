...
### Linux x86_64 4.15.0-46+ (Check Linux version with uname -r)
Simply download _wheelers-wort-works-4.15.0-46-generic-x64_ and run it with the command `./wheelers-wort-works-4.15.0-46-generic-x64`. If you require specific run permissions run `sudo chmod a+x wheelers-wort-works-4.15.0-46-generic-x64`
...
Open a terminal, and cd into your `wheelers-wort-works-master` folder, then open with `python3 main.py` or `python main.py`.
